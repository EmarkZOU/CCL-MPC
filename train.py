...
def get_args():
    ...
    parser.add_argument('--config', type=str, default='/opt/data/private/zyb/UGPCL-master/configs/isic/ugpcl_unet_r50.yaml',
...
def train():
    ...
    train_loader, unlabeled_loader, val_loader = build_dataloader(args.dataset, worker_init_fn)
    ...
    trainer.train(train_loader, unlabeled_loader, val_loader)
    logger.close()
